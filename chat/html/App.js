window.APP = {
  ...
  data() {
    return {
      ...
      oldMessages: [],
      oldMessagesIndex: -1,
      showChatOnMessage: CONFIG.showChatOnMessage
    };
  },
  destroyed() {
  ...
  methods: {
    ...
    ON_TOGGLE_CHAT_OPEN_ON_MSG({cval}){
      CONFIG.showChatOnMessage = cval;
    },
    warn(msg) {
      this.messages.push({
        args: [msg],
