...
chairs.config = {
  ...
  prop_bench_01a        = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_01b        = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_01c        = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_02         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_03         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_04         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_05         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_06         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_05         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_08         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_09         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_10         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_bench_11         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_fib_3b_bench     = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_ld_bench01       = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  prop_wait_bench_01    = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  ...
  prop_skid_chair_01      = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset =  0.0, forwardOffset = 0.0, leftOffset = 0.0},
  ...
  v_ret_gc_chair03        = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.2, forwardOffset = 0.0, leftOffset = 0.0},
  ...
  ["-1202648266"]         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, leftOffset = 0.0},
  ["-470815620"]          = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, leftOffset = 0.0},
  v_club_stagechair       = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
  ["538002882"]           = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, leftOffset = 0.0},
  ...
  ["-523951410"]          = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
  ["1580642483"]          = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.05, forwardOffset = 0.0, leftOffset = 0.0},
  ...
  p_v_med_p_sofa_s        = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, offsetLr = 0.6},
  ...
  ["-1786424499"]         = { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, leftOffset = 0.0},

  -- BEDS
  v_med_bed1              = { scenario = "WORLD_HUMAN_BUM_SLUMPED", verticalOffset = -1.0, forwardOffset = 0.0, leftOffset = 0.0, desc = "lay", other = true, rot = 225.0},
  ["2117668672"]          = { scenario = "WORLD_HUMAN_BUM_SLUMPED", verticalOffset = -1.0, forwardOffset = 0.0, leftOffset = 0.0, desc = "lay", other = true, rot = 225.0},
  ["-1091386327"]         = { scenario = "WORLD_HUMAN_BUM_SLUMPED", verticalOffset = -1.0, forwardOffset = 0.0, leftOffset = 0.0, desc = "lay", other = true, rot = 90.0},
  ["1631638868"]          = { scenario = "WORLD_HUMAN_BUM_SLUMPED", verticalOffset = -1.0, forwardOffset = 0.0, leftOffset = 0.0, desc = "lay", other = true, rot = 225.0},
  ["-1182962909"]         = { scenario = "WORLD_HUMAN_BUM_SLUMPED", verticalOffset = -1.0, forwardOffset = 0.0, leftOffset = 0.0, desc = "lay", other = true, rot = 90.0}
}

chairs.shadowspots = {
  {pos = {x = 0, y = 0, z = 0}, spread = true, spreadbias = 0.29}
}

--[[
  ## hash/model names must be added to both lists ##
]]